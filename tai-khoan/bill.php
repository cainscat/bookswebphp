...
<div class="div-body-panel" style="height: 911px;">
	...
	<div class="cart-body">
        ...
        <th width="10%" style="text-align: center;">Tình trạng</th>
          ...
          echo '<td>';
					?>
            	<font color="blue"><?php if($row['history_status'] == 'Chưa xác nhận') echo '<a href="tai-khoan/delete_bill.php?id='.$row['history_id'].'" onclick="return huy()">Hủy đơn hàng</a>'; else echo '<a href="tai-khoan/delete_bill.php?id='.$row['history_id'].'">Xóa</a>';?></font>
					<?php
					echo '</td>';
          echo '<td>';
